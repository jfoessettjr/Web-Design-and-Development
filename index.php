<?php
require_once('C:\xampp\htdocs\CMPS\CMPS 261\Module 4\model\fields.php');
require_once('C:\xampp\htdocs\CMPS\CMPS 261\Module 4\model\validate.php');
...
switch ($action) {
    case 'reset':
        ...
        include 'C:\xampp\htdocs\CMPS\CMPS 261\Module 4\view\register.php';
        break;
    case 'register':
        ...
        if ($fields->hasErrors()) {
            ...
            include 'C:\xampp\htdocs\CMPS\CMPS 261\Module 4\view\success.php';
        }
        break;
}
?>